...
function MiniCalendar({
  ...
  const startPad = getDay(start); // 0 = Sunday

  // Set of date strings with appointments
...
export default function SchedulePage() {
  const { appointments, setAppointments, transactions, setTransactions, isHydrated } =
    useClinic();
